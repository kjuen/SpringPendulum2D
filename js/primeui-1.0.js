...
$(function() {
    ...
    $.widget("primeui.puiaccordion", {
        ...
        _create: function() {
            //if(this.options.multiple && this.options.activeIndex===null) {
            //     this.options.activeIndex = [];
            //}
            if(Array.isArray(this.options.activeIndex) == false)
            {
                if (this.options.activeIndex !== null)
            ...
            this.element.children('h3').addClass('pui-accordion-header ui-helper-reset ui-state-default').each(function(i) {
                var header = $(this),
                title = header.html(),
                headerClass = ($this.options.activeIndex.indexOf(i) != -1) ? 'ui-state-active ui-corner-top' : 'ui-corner-all',
                iconClass = ($this.options.activeIndex.indexOf(i) != -1) ? 'ui-icon ui-icon-triangle-1-s' : 'ui-icon ui-icon-triangle-1-e';
            ...
            this.element.children('div').each(function(i) {
                ...
                if($this.options.activeIndex.indexOf(i) == -1) {
